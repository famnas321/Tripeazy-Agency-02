...
const {addPackages,fetchPackages,updateLike,deletePackage,editPackage} = require("../Controller/packageController")
...
router.put("/editPackage", authMiddleware,upload.array("image"),editPackage)
